...
# read json file and process the required files:
...
# Tokenzization: Vectorize data using the Tokenization method
...
def chat():
    model = keras.models.load_model("chat_model")   # load trained model
